          ...
          <div className="content container-fluid w-75">
            <form onSubmit={handleSubmit}>
              <div className="content-page-header">
                <h5 className="text-primary text-bold">Edit Product</h5>
              </div>
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-12">
                    <div className="upload-gif form-group text-center">
                      <label style={{ color: "#9265cc" }}>
                ...
                <div className="row">
                  <div className="add-customer-btns mb-5 d-flex justify-content-end w-100">
                    <div className="d-flex">
                      <Link
                        to="/Masterproductlist"
                        className="btn btn-cancel btn-outline-primary mx-2 px-5"
                      >
                        Cancel
                      </Link>
                      <button
                        type="submit"
                        className="btn btn-save btn-outline-primary mx-2 px-5"
                      >
                        Update
                      </button>
                    </div>
...
export default MasterEditProduct;
